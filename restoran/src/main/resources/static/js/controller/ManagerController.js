...
angular.module('myApp').controller('ManagerController',['$scope','$http','$window','$route','$ocLazyLoad','$mdDialog','$timeout', function($scope, $http,$window, $route, $ocLazyLoad, $mdDialog, $timeout) {
    ...
    $scope.newSupply=function(){
      ...
      $scope.dayEndHour     = 23;               // The hour number at which the day ends   (default 20:00)

      // Create the events list
      $scope.events = [
         { id: 0, title: 'Yesterday afternoon', type: 'urgent',
           startDate: new Date(2017, 5-1,  9, 13, 0), endDate: new Date(2016, 9-1,  9, 20, 0) },
         { id: 1, title: 'Today morning', type: 'normal',
           startDate: new Date(2017, 5-25, 10,  8, 0), endDate: new Date(2016, 9-1, 10, 12, 0) },
         { id: 7, title: 'Today Afternoon', type: 'normal',
           startDate: new Date(2017, 5-24, 10, 14, 0), endDate: new Date(2016, 9-1, 10, 19, 0) },
