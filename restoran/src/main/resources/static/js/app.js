var app = angular.module("myApp", ['oc.lazyLoad', 'ngRoute', 'ngComboDatePicker','dnTimepicker','dndLists','ngMaterial','ngMaterialDatePicker']);
...
/*
app.config(['$ocLazyLoadProvider', function($ocLazyLoadProvider, $routeProvider) {
	  $ocLazyLoadProvider.config({
		  modules: [{
			    name: 'TestModule',
			    files: ['assets/js/common-scripts.js']
			  }]
		  });
	  $routeProvider
	    .when("/", {
